...
namespace Rest_O_Bot.Bots
{
        ...
        where T : Dialog
    {
        ...
        protected readonly IEnumerable<Dialog> Dialogs;

        public DialogBot(ConversationState conversationState, UserState userState, T dialog, IEnumerable<Dialog> otherDialogs, ILogger<DialogBot<T>> logger)
        {
