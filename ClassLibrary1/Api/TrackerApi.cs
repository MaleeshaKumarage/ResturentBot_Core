...
namespace ApiClient.Api
{
    ...
    public partial class TrackerApi : ITrackerApi
    {
        ...
        /// <returns></returns>
        public TrackerApi(ApiClient.Client.Configuration configuration)
        {
        ...
        public TrackerApi(ApiClient.Client.ISynchronousClient client, ApiClient.Client.IAsynchronousClient asyncClient, ApiClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            ApiClient.Client.ApiResponse<InlineResponse2002> localVarResponse = ConversationsConversationIdExecutePostWithHttpInfo(conversationId, actionRequest, includeEvents, outputChannel);
        ...
        /// <param name="outputChannel">The bot&#39;s utterances will be forwarded to this channel. It uses the credentials listed in &#x60;credentials.yml&#x60; to connect. In case the channel does not support this, the utterances will be returned in the response body. Use &#x60;latest&#x60; to try to send the messages to the latest channel the user used. Currently supported channels are listed in the permitted values for the parameter. (optional)</param>
        /// <returns>ApiResponse of InlineResponse2002</returns>
        public ApiClient.Client.ApiResponse<InlineResponse2002> ConversationsConversationIdExecutePostWithHttpInfo(string conversationId, ActionRequest actionRequest, string includeEvents = null, string outputChannel = null)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter 'conversationId' when calling TrackerApi->ConversationsConversationIdExecutePost");

            // verify the required parameter 'actionRequest' is set
            if (actionRequest == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter 'actionRequest' when calling TrackerApi->ConversationsConversationIdExecutePost");
            ...
            if (conversationId != null)
                requestOptions.PathParameters.Add("conversation_id", ApiClient.Client.ClientUtils.ParameterToString(conversationId)); // path parameter
            if (includeEvents != null)
            {
                foreach (var kvp in ApiClient.Client.ClientUtils.ParameterToMultiMap("", "include_events", includeEvents))
                {
            ...
            {
                foreach (var kvp in ApiClient.Client.ClientUtils.ParameterToMultiMap("", "output_channel", outputChannel))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
        ...
        {
            ApiClient.Client.ApiResponse<InlineResponse2002> localVarResponse = await ConversationsConversationIdExecutePostAsyncWithHttpInfo(conversationId, actionRequest, includeEvents, outputChannel);
            return localVarResponse.Data;
        ...
        /// <param name="outputChannel">The bot&#39;s utterances will be forwarded to this channel. It uses the credentials listed in &#x60;credentials.yml&#x60; to connect. In case the channel does not support this, the utterances will be returned in the response body. Use &#x60;latest&#x60; to try to send the messages to the latest channel the user used. Currently supported channels are listed in the permitted values for the parameter. (optional)</param>
        /// <returns>Task of ApiResponse (InlineResponse2002)</returns>
        public async System.Threading.Tasks.Task<ApiClient.Client.ApiResponse<InlineResponse2002>> ConversationsConversationIdExecutePostAsyncWithHttpInfo(string conversationId, ActionRequest actionRequest, string includeEvents = null, string outputChannel = null)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter 'conversationId' when calling TrackerApi->ConversationsConversationIdExecutePost");
        ...
        {
            ApiClient.Client.ApiResponse<Tracker> localVarResponse = ConversationsConversationIdMessagesPostWithHttpInfo(conversationId, message, includeEvents);
            return localVarResponse.Data;
        }
        ...
        /// <param name="includeEvents">Specify which events of the tracker the response should contain. (optional, default to AFTER_RESTART)</param>
        /// <returns>ApiResponse of Tracker</returns>
        public ApiClient.Client.ApiResponse<Tracker> ConversationsConversationIdMessagesPostWithHttpInfo(string conversationId, Message message, string includeEvents = null)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
        ...
        {
            ApiClient.Client.ApiResponse<Tracker> localVarResponse = await ConversationsConversationIdMessagesPostAsyncWithHttpInfo(conversationId, message, includeEvents);
            return localVarResponse.Data;
        ...
        /// <param name="includeEvents">Specify which events of the tracker the response should contain. (optional, default to AFTER_RESTART)</param>
        /// <returns>Task of ApiResponse (Tracker)</returns>
        public async System.Threading.Tasks.Task<ApiClient.Client.ApiResponse<Tracker>> ConversationsConversationIdMessagesPostAsyncWithHttpInfo(string conversationId, Message message, string includeEvents = null)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter 'conversationId' when calling TrackerApi->ConversationsConversationIdMessagesPost");
        ...
        {
            ApiClient.Client.ApiResponse<PredictResult> localVarResponse = ConversationsConversationIdPredictPostWithHttpInfo(conversationId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="conversationId">Id of the conversation</param>
        /// <returns>ApiResponse of PredictResult</returns>
        public ApiClient.Client.ApiResponse<PredictResult> ConversationsConversationIdPredictPostWithHttpInfo(string conversationId)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter 'conversationId' when calling TrackerApi->ConversationsConversationIdPredictPost");
        ...
        {
            ApiClient.Client.ApiResponse<PredictResult> localVarResponse = await ConversationsConversationIdPredictPostAsyncWithHttpInfo(conversationId);
            return localVarResponse.Data;
        ...
        /// <param name="conversationId">Id of the conversation</param>
        /// <returns>Task of ApiResponse (PredictResult)</returns>
        public async System.Threading.Tasks.Task<ApiClient.Client.ApiResponse<PredictResult>> ConversationsConversationIdPredictPostAsyncWithHttpInfo(string conversationId)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter 'conversationId' when calling TrackerApi->ConversationsConversationIdPredictPost");
        ...
        /// <param name="until">All events previous to the passed timestamp will be replayed. Events that occur exactly at the target time will be included. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiClient.Client.ApiResponse<Object> ConversationsConversationIdStoryGetWithHttpInfo(string conversationId, decimal? until = null)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter 'conversationId' when calling TrackerApi->ConversationsConversationIdStoryGet");
            ...
            if (until != null)
            {
                foreach (var kvp in ApiClient.Client.ClientUtils.ParameterToMultiMap("", "until", until))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
        ...
        /// <param name="until">All events previous to the passed timestamp will be replayed. Events that occur exactly at the target time will be included. (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiClient.Client.ApiResponse<Object>> ConversationsConversationIdStoryGetAsyncWithHttpInfo(string conversationId, decimal? until = null)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter 'conversationId' when calling TrackerApi->ConversationsConversationIdStoryGet");
        ...
        {
            ApiClient.Client.ApiResponse<Tracker> localVarResponse = ConversationsConversationIdTrackerEventsPostWithHttpInfo(conversationId, events, includeEvents);
            return localVarResponse.Data;
        }
        ...
        /// <param name="includeEvents">Specify which events of the tracker the response should contain. (optional, default to AFTER_RESTART)</param>
        /// <returns>ApiResponse of Tracker</returns>
        public ApiClient.Client.ApiResponse<Tracker> ConversationsConversationIdTrackerEventsPostWithHttpInfo(string conversationId, Event[] events, string includeEvents = null)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter 'conversationId' when calling TrackerApi->ConversationsConversationIdTrackerEventsPost");

            // verify the required parameter 'events' is set
            if (events == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter 'events' when calling TrackerApi->ConversationsConversationIdTrackerEventsPost");
        ...
        {
            ApiClient.Client.ApiResponse<Tracker> localVarResponse = await ConversationsConversationIdTrackerEventsPostAsyncWithHttpInfo(conversationId, events, includeEvents);
            return localVarResponse.Data;
        ...
        /// <param name="includeEvents">Specify which events of the tracker the response should contain. (optional, default to AFTER_RESTART)</param>
        /// <returns>Task of ApiResponse (Tracker)</returns>
        public async System.Threading.Tasks.Task<ApiClient.Client.ApiResponse<Tracker>> ConversationsConversationIdTrackerEventsPostAsyncWithHttpInfo(string conversationId, Event[] events, string includeEvents = null)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter 'conversationId' when calling TrackerApi->ConversationsConversationIdTrackerEventsPost");
        ...
        {
            ApiClient.Client.ApiResponse<Tracker> localVarResponse = ConversationsConversationIdTrackerEventsPutWithHttpInfo(conversationId, _event, includeEvents);
            return localVarResponse.Data;
        }
        ...
        /// <param name="includeEvents">Specify which events of the tracker the response should contain. (optional, default to AFTER_RESTART)</param>
        /// <returns>ApiResponse of Tracker</returns>
        public ApiClient.Client.ApiResponse<Tracker> ConversationsConversationIdTrackerEventsPutWithHttpInfo(string conversationId, List<Event> _event, string includeEvents = null)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter 'conversationId' when calling TrackerApi->ConversationsConversationIdTrackerEventsPut");

            // verify the required parameter '_event' is set
            if (_event == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter '_event' when calling TrackerApi->ConversationsConversationIdTrackerEventsPut");
        ...
        {
            ApiClient.Client.ApiResponse<Tracker> localVarResponse = await ConversationsConversationIdTrackerEventsPutAsyncWithHttpInfo(conversationId, _event, includeEvents);
            return localVarResponse.Data;
        ...
        /// <param name="includeEvents">Specify which events of the tracker the response should contain. (optional, default to AFTER_RESTART)</param>
        /// <returns>Task of ApiResponse (Tracker)</returns>
        public async System.Threading.Tasks.Task<ApiClient.Client.ApiResponse<Tracker>> ConversationsConversationIdTrackerEventsPutAsyncWithHttpInfo(string conversationId, List<Event> _event, string includeEvents = null)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter 'conversationId' when calling TrackerApi->ConversationsConversationIdTrackerEventsPut");
        ...
        {
            ApiClient.Client.ApiResponse<Tracker> localVarResponse = ConversationsConversationIdTrackerGetWithHttpInfo(conversationId, includeEvents, until);
            return localVarResponse.Data;
        }
        ...
        /// <param name="until">All events previous to the passed timestamp will be replayed. Events that occur exactly at the target time will be included. (optional)</param>
        /// <returns>ApiResponse of Tracker</returns>
        public ApiClient.Client.ApiResponse<Tracker> ConversationsConversationIdTrackerGetWithHttpInfo(string conversationId, string includeEvents = null, decimal? until = null)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter 'conversationId' when calling TrackerApi->ConversationsConversationIdTrackerGet");
        ...
        {
            ApiClient.Client.ApiResponse<Tracker> localVarResponse = await ConversationsConversationIdTrackerGetAsyncWithHttpInfo(conversationId, includeEvents, until);
            return localVarResponse.Data;
        ...
        /// <param name="until">All events previous to the passed timestamp will be replayed. Events that occur exactly at the target time will be included. (optional)</param>
        /// <returns>Task of ApiResponse (Tracker)</returns>
        public async System.Threading.Tasks.Task<ApiClient.Client.ApiResponse<Tracker>> ConversationsConversationIdTrackerGetAsyncWithHttpInfo(string conversationId, string includeEvents = null, decimal? until = null)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
                throw new ApiClient.Client.ApiException(400, "Missing required parameter 'conversationId' when calling TrackerApi->ConversationsConversationIdTrackerGet");
